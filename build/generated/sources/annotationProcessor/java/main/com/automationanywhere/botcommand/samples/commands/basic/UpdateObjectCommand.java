...
public final class UpdateObjectCommand implements BotCommand {
  private static final Logger logger = LogManager.getLogger(UpdateObjectCommand.class);
  ...
  public Optional<Value> execute(GlobalSessionContext globalSessionContext,
    ...
    UpdateObject command = new UpdateObject();
    ...
    try {
      Optional<Value> result =  Optional.ofNullable(command.action((String)convertedParameters.get("sessionName"),(String)convertedParameters.get("objectType"),(String)convertedParameters.get("objectID"),(Map<String, Value>)convertedParameters.get("insertDictionary")));
